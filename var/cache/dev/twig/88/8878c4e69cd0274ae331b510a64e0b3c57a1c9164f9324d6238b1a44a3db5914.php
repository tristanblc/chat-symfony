...
/* user/new.html.twig */
class __TwigTemplate_0a4a8b067cb4730e1c35639dd5fcb2dd0dfd7a84509d85519d908cdb3da7c738 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        $this->loadTemplate("navbar/navbar.html.twig", "user/new.html.twig", 6)->display($context);
        // line 7
...
";
        // line 10
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 10, $this->source); })()), 'form_start', ["attr" => ["id" => "new_edit_utilisateur"]]);
        echo "
";
        // line 12
        echo "        <div class=\"row\">
                <div class=\"col-12\">
                        ";
        // line 14
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 14, $this->source); })()), "username", [], "any", false, false, false, 14), 'label');
        echo "
                        ";
        // line 15
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 15, $this->source); })()), "username", [], "any", false, false, false, 15), 'widget', ["label" => "Nom du canal :", "attr" => ["class" => "form-control"]]);
        echo "
                </div>
                <div class=\"col-12\">
                        ";
        ...
        echo "
                        ";
        // line 19
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 19, $this->source); })()), "password", [], "any", false, false, false, 19), 'widget', ["label" => "Nom du canal :", "attr" => ["class" => "form-control"]]);
        echo "
                </div>
        </div>
        <br>
...
";
    ...
    {
        return array (  131 => 28,  124 => 27,  114 => 24,  110 => 23,  103 => 19,  99 => 18,  93 => 15,  89 => 14,  85 => 12,  81 => 10,  76 => 7,  74 => 6,  67 => 5,  54 => 3,  37 => 1,);
    }
...
{# utilisation de classes bootstrap pour la mise en forme #}
        <div class=\"row\">
                <div class=\"col-12\">
                        ...
                        {{ form_widget(form.username,{ 'label': 'Nom du canal :','attr': {'class': 'form-control'}}) }}
                </div>
                <div class=\"col-12\">
                        {{ form_label(form.password) }}
                        {{ form_widget(form.password,{ 'label': 'Nom du canal :','attr': {'class': 'form-control'}}) }}
                </div>
        </div>
        <br>
...
{% endblock %}", "user/new.html.twig", "C:\\Users\\trito\\Documents\\GitHub\\chat-projet-symfony\\projet_chat\\templates\\user\\new.html.twig");
    }
}
