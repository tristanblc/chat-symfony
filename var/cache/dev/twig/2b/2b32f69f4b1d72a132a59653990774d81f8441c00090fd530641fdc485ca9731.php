...
class __TwigTemplate_546f0f1ef4c9478b209d7ca8f71e471b947052eac5659b6a65369cf6bfd19aed extends Template
{
    private $source;
    private $macros = [];
    ...
    <button class=\"btn\">";
        // line 3
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 3, $this->source); })()), "Modifier")) : ("Modifier")), "html", null, true);
        echo "</button>
";
        // line 4
...
{{ form_end(form) }}
", "user/_form.html.twig", "C:\\Users\\trito\\Documents\\GitHub\\chat-projet-symfony\\projet_chat\\templates\\user\\_form.html.twig");
    }
}
