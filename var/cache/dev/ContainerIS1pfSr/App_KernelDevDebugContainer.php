...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'console.command.public_alias.App\\Command\\ChannelCommand' => 'getChannelCommandService',
            'console.command.public_alias.App\\Command\\SupChannelCommand' => 'getSupChannelCommandService',
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uW-cKKsXeE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'console.command.ids' => [
                0 => 'console.command.public_alias.App\\Command\\ChannelCommand',
                1 => 'console.command.public_alias.App\\Command\\SupChannelCommand',
            ],
        ];
    }
